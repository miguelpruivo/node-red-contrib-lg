...
module.exports = {
  ...
  WindStrength: {
    ...
    HIGH: 6,
    POWER: 7,
    AUTO: 8, // LG's model JSON labels value 8 "NATURE", but it is the app's "auto" fan
    NATURE: 8, // alias for the same value
  },
  ...
  KEYS: {
    ...
    // Panel display LED. Inverted: 0 = LED on, 1 = LED off (the _W variants 11/12
    // are other models). Only takes effect while the unit is on. Verified live.
    DISPLAY: 'airState.lightingState.displayControl',
  },
};
